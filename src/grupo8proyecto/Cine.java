...
public class Cine {
    ...
    public Cine() {
        // Capacidades fijas
        peliculas = new Pelicula[10];   // Máximo 10 películas
        salas = new Sala[5];            // Máximo 5 salas
        funciones = new Funcion[20];    // Máximo 20 funciones
        clientes = new Cliente[50];     // Máximo 50 clientes
        boletos = new Boletos[100];     // Máximo 100 boletos
    ...
    // Guardar la película en la posición libre
        peliculas[cantPeliculas] = p;
    // Aumentar el contador de películas
        cantPeliculas++;
    ...
    private int edadMinimaPorClasificacion(Clasificacion clasif) {
        switch (clasif) {
            case TP:
                return 0;
            case TP12:
